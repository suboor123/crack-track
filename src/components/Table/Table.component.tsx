...
<div className="table-responsive  shadow-md rounded-md">
  <table className="table mb-0 table-center">
    <thead>
      <tr>
        <th scope="col" className="fw-normal border-bottom text-muted py-4 px-3" style={{minWidth: 250}}>Name</th>
        <th scope="col" className="fw-normal border-bottom text-muted py-4 px-3" style={{width: 150}}>Price</th>
        <th scope="col" className="fw-normal border-bottom text-muted py-4 px-3" style={{width: 150}}>Change(%)</th>
        <th scope="col" className="fw-normal border-bottom text-muted py-4 px-3" style={{width: 150}}>Change($)</th>
        <th scope="col" className="fw-normal border-bottom text-muted py-4 px-3" style={{width: 150}}>Marketcap</th>
        <th scope="col" className="fw-normal border-bottom text-muted py-4 px-3 text-end" style={{width: 100}}>Trade</th>
      </tr>
    </thead>
    <tbody>
      <tr>
        <th className="p-3">
          <div className="align-items-center">
            <img src="assets/images/crypto/bitcoin.png" className="me-3" height={32} />
        ...
        <td className="p-3 text-end"><a href="javascript:void(0)" className="btn btn-sm btn-primary">Trade</a></td>
      </tr>
      <tr>
        <th className="p-3">
          <div className="align-items-center">
            <img src="assets/images/crypto/litecoin.png" className="me-3" height={32} />
      ...
      <tr>
        <th className="p-3">
          <div className="align-items-center">
            <img src="assets/images/crypto/auroracoin.png" className="me-3" height={32} />
      ...
      <tr>
        <th className="p-3">
          <div className="align-items-center">
            <img src="assets/images/crypto/coinye.png" className="me-3" height={32} />
      ...
      <tr>
        <th className="p-3">
          <div className="align-items-center">
            <img src="assets/images/crypto/ethereum.png" className="me-3" height={32} />
      ...
      <tr>
        <th className="p-3">
          <div className="align-items-center">
            <img src="assets/images/crypto/potcoin.png" className="me-3" height={32} />
      ...
      <tr>
        <th className="p-3">
          <div className="align-items-center">
            <img src="assets/images/crypto/zcash.png" className="me-3" height={32} />
      ...
      <tr>
        <th className="p-3">
          <div className="align-items-center">
            <img src="assets/images/crypto/primecoin.png" className="me-3" height={32} />
      ...
      <tr>
        <th className="p-3">
          <div className="align-items-center">
            <img src="assets/images/crypto/blocknet.png" className="me-3" height={32} />
      ...
      <tr>
        <th className="p-3">
          <div className="align-items-center">
            <img src="assets/images/crypto/kucoin.png" className="me-3" height={32} />

                        ...
                        <div className="dropdown dropdown-primary">
                            ...
                            >
                                <Link
                                    ...
                                    to="/profile"
                                >
                                    <i className="uil uil-user align-middle me-1" />{' '}
                                    {currentUserModel.pluck('username')}
                                </Link>
                                ...
                                <a className="dropdown-item text-dark">
                                    <i className="uil uil-arrow-circle-down align-middle me-1" />{' '}
                                    Download
                                </a>
                                {currentUserModel.isAdmin && (
                                    <a className="dropdown-item text-dark">
                                        <i className="uil uil-dashboard align-middle me-1" />
                                        Admin Dashboard
                                    </a>
                                )}

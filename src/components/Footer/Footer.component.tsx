...
const Footer = () => {
    return (
        <footer className="footer mt-100" style={{ backgroundImage: 'url("assets/images/svg-map.svg")', backgroundRepeat: 'no-repeat', backgroundPosition: 'center' }}>
            <div className="container">
                <div className="row justify-content-center">
                    <div className="col-12 py-lg-5">
                        <div className="footer-py-60 text-center">
                            <a href="footer.html#" className="logo-footer">
                                <img src="assets/images/logo-light.png" height={32} />
                            </a>
                    ...
                    <div className="row justify-content-center">
                        <div className="col-12">
                            <div className="text-center">
                                <p className="mb-0">© 2022 Landrick. Design with <i className="mdi mdi-heart text-danger" /> by <a href="../../index.html" target="_blank" className="text-reset">Shreethemes</a>.</p>
                            </div>
                        </div>{/*end col*/}
                    </div>{/*end row*/}
                </div>{/*end container*/}

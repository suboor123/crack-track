            ...
            async ([percent, downloadedUrl]) => {
                ...
                if (percent === 100 && downloadedUrl) {
                    ...
                    setTimeout(() => {
                        ...
                        Toastr.fire(
                            `Looking good ${userModel.firstName}`,
                            `Awesome!`
                        ).success();
                    }, 500);
                }
        ...
        <>
            ...
            <div className="mt-5 text-center">
                ...
                {selectedFileUrl && (
                    ...
                    >
                        <i className="uil uil-upload align-middle me-1 text-center"></i>{' '}
                        Upload
                    </UserButton>
                )}

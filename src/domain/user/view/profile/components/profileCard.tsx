  ...
  return (
    <>
                  ...
                  <div className="row align-items-center py-3">
                    <ProfileImage userModel={userModel}>
                      ...
                      <span
                        ...
                        <i className="uil uil-edit align-middle me-1"
                        ></i> <span className="inline-block mt-5">
                          Edit
                        </span>
                      </span>
                      </Tooltip>
                      ...
                      <div className="row align-items-end">
                        <div className="col-md-7 text-md-start text-center mt-4 mt-sm-0">
                          <h3 className="title mb-0">
                            ...
                            {userModel.pluck('username')} <OfficialAccountIcon userModel={userModel}></OfficialAccountIcon></div>  
                            <span style={{zIndex: 1}}>
                            </span>
                          </h3>
                          <small className="text-muted h6 me-2">{userModel.pluck('aboutMe')}</small>
                          <br /> <EditProfilePopup
      ...
      <Modal modalConfig={{
        ...
        <ProfileImageUploader userModel={userModel} afterUpload={closeModal}></ProfileImageUploader>
      </Modal>
    </>
  )
}

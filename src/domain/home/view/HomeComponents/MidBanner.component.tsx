    ...
    return (
        <>
            <div className="container-fluid mt-100 mt-60">
                <div
                    className="py-5"
                    style={{ background: 'url("assets/images/svg-map.svg")' }}
                >
                    <div className="container">
                        <div className="row justify-content-center">
                            <div className="col-12 text-center">
                                <span
                                    className="clip-text clip-text-image text-uppercase fw-bold"
                                    style={{
                                        backgroundImage:
                                            'url("assets/images/logistics/01.jpg")',
                                    }}
                                >
                                    enroll now
                                </span>
            ...
            <div className="container-fluid mt-100 mt-60">
                <div
                    ...
                    style={{
                        background: 'url("assets/images/3.jpg") center center',
                    }}
                >
                        ...
                        <div className="row justify-content-center">
                            <div className="col-12">
                                <div className="section-title text-center">
                                    <h2 className="fw-bold text-white title-dark  pb-2">
                                        People are preparing from <br /> all
                                        over the world
                                    </h2>
            ...
            >
                <div className="row align-items-center g-0">
                    ...
                    <div className="col-lg-6 col-md-7">
                        <div className="p-3">
                            <LoginForm
                                onSubmissionCompleted={closeLoginModal}
                            ></LoginForm>
                        </div>
                    </div>
                    {/*end col*/}

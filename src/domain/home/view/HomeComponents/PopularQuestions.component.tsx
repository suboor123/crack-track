...
const PopularQuestions: React.FC = () => {
    return (
        ...
        <div className="row align-items-center my-4 pb-2">
          <div className="col-md-8">
          <br /><br />
            <div className="section-title text-center text-md-start">
              <h4 className="mb-4">Popular Topics</h4>
        ...
        <div className="row">
          <div className="col-lg-4 col-md-6 mt-4 pt-2">
            <div className="card blog blog-primary rounded border-0 shadow overflow-hidden">
              <div className="position-relative">
                <img src="assets/images/blog/01.jpg" className="card-img-top" alt="..." />
              ...
              <div className="card-body content">
                ...
                <div className="post-meta d-flex justify-content-between mt-3">
                  ...
                  <a href="blog-detail.html" className="text-muted readmore">Read More <i className="uil uil-angle-right-b align-middle" /></a>
                </div>
              </div>
          ...
          <div className="col-lg-4 col-md-6 mt-4 pt-2">
            <div className="card blog blog-primary rounded border-0 shadow overflow-hidden">
              <div className="position-relative">
                <img src="assets/images/blog/02.jpg" className="card-img-top" alt="..." />
                <div className="overlay rounded-top" />
              </div>
              <div className="card-body content">
          ...
          <div className="col-lg-4 col-md-6 mt-4 pt-2">
            <div className="card blog blog-primary rounded border-0 shadow overflow-hidden">
              <div className="position-relative">
                <img src="assets/images/blog/03.jpg" className="card-img-top" alt="..." />
                <div className="overlay rounded-top" />
              </div>
              <div className="card-body content">

...
function AddTopic(props: Props) {
  ...
  const onSubmit = async (values: TopicFrom, resetForm: () => void) => {
    ...
    TopicModel.uploadImage(imageFile as any,
  ...
  return (
    <>
      ...
      <div className="mt-3 text-md-start text-center d-md-flex">
        <img src={selectedImageUrl} className="avatar float-md-left avatar-medium rounded-circle shadow me-md-4"
          style={{ objectFit: 'cover' }}
        />
        <div className="mt-md-4 mt-3 mt-sm-0">
          <a onClick={handleChooseFileBtnClick} className="btn btn-primary mt-2">Choose Picture</a>

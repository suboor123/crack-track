...
export default function AddQuestion() {
    ...
    return (
        <>
            <Animation.Slide in={currentPage === CurrentForm.DetailForm}
                placement={ANIMATION_PLACEMENT}>
                {(props, ref) => (<>
                    {currentPage === CurrentForm.DetailForm && <div ref={ref} {...props}>
                                    ...
                                    <div className="col-md-6">
                                        <div className="card-body bg-white p-5">
                                            <h4 className=" text-center">
                                                Question</h4>
                                            <hr />
                                            <QuestionForm formValues={formValues} onSubmission={onCompletingFirstForm}></QuestionForm>
                                        </div>
            ...
            <Animation.Slide in={currentPage === CurrentForm.ContentForm}
                placement={ANIMATION_PLACEMENT}>
                {(props, ref) => (<>
                    {currentPage === CurrentForm.ContentForm && <QuestionContent
                        {...props}
                        ref={ref}
                        prevFormValues={formValues}
                        onBackClick={() => setCurrentPage(CurrentForm.DetailForm)}
            ...
            <Animation.Slide in={true}
                placement={ANIMATION_PLACEMENT}>
                {(props, ref) => (
                    (<> {currentPage === CurrentForm.Preview && <QuestionPreview
                        {...props}
                        ref={ref}

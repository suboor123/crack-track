...
function App({ currentUser }: Props) {
    ...
    const unsupportedHomeSnippets = ['login', 'registration', 'add-question'];
        ...
        <div className="main-wrapper">
            {loadApp && (
                <BrowserRouter>
                    ...
                    <Routes>
                        ...
                        <Route path="/profile" element={<UserProfile />}>
                            <Route
                                ...
                                element={
                                    <PersonalDetails
                                        currentUserModel={UserModel.make(
                                            currentUser!
                                        )}
                                    />
                                }
                    ...
                    <RouteChangeDetector
                        routeChange={(activeRoute: string) =>
                            setCurrentLocation(activeRoute)
                        }
                    />

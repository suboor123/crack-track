    ...
    return (
        <Formik
            ...
            onSubmit={async (
                ...
                if (user) {
                    Toastr.fire(`Welcome ${user.username}`, 'Logged in').success();
                    navigate('/')
                }
            }}
        >
                        ...
                        <div className="col-md-12">
                            <div className="mb-3">
                                <div className="form-check">
                                    ...
                                    <label className="form-check-label" htmlFor="flexCheckDefault">I Accept <a href="auth-signup.html#" className="text-primary">Terms And Condition</a></label>
                                </div>
                            </div>
                        </div>{/*end col*/}
                        <div className="col-md-12">
                            <div className="d-grid">
                                ...
                                <Button tooltipText="Success is the progressive realization of a worthy goal."
                                    onSubmit={() => formik.submitForm()}>Register</Button>
                            </div>
                        </div>{/*end col*/}
                        <div className="col-lg-12 mt-4 text-center">
                            ...
                            <div className="row">
                                <div className="col-6 mt-3">
                                    <div className="d-grid">
                                        <a className="btn btn-light"><i className="mdi mdi-facebook text-primary" /> Facebook</a>
                                    </div>
                                </div>{/*end col*/}
                                <div className="col-6 mt-3">
                                    <div className="d-grid">
                                        <a className="btn btn-light"><i className="mdi mdi-google text-danger" /> Google</a>
                                    </div>
                                </div>{/*end col*/}
                            </div>
                        </div>{/*end col*/}
                        <div className="mx-auto">
                            <p className="mb-0 mt-3"><small className="text-dark me-2">Already have an account ?</small>
                                <Link to="/login" className="text-dark fw-bold">Sign in</Link></p>
                        </div>
                    </div>
                </Form>
            )}

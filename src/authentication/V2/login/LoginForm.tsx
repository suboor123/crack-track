    ...
    return (
        <Formik
            ...
            onSubmit={async (values, formikHelpers: FormikHelpers<any>) => {
                const user = await AuthModel.authenticateUser(values.email, values.password);
                if (user) {
                    if (props.onSubmissionCompleted) props.onSubmissionCompleted();
                    navigate('/')
                }
                ...
                <Form>
                    <div className="row">
                            ...
                            <div className="d-flex justify-content-between">
                                <div className="mb-3">
                                    <div className="form-check">
                                        <Tooltip content={'Keep me logged in'} placement='left'>
                        ...
                        <div className="col-lg-12 mb-0">
                            <div className="d-grid">
                                <Button
                                    ...
                                    onSubmit={() => formik.submitForm()}>Sign in</Button>
                            </div>
                        </div>{/*end col*/}
                        ...
                        <div className="col-12 text-center">
                            <p className="mb-0 mt-3"><small className="text-dark me-2">Don't have an account ?</small> <Link to="/registration" className="text-dark fw-bold">Sign Up</Link></p>
                        </div>{/*end col*/}
                    </div>
                </Form>
            )}
